...
```bash
skills/project/smoke-test-herdr-reviewr/scripts/test.sh
```
...
- When debugging why the `prefix+cmd+r` toggle or `persiyanov.reviewr.toggle` keybinding isn't opening
  the sidebar.
