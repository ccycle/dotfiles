...
check_symlink "$HOME/.claude/skills" "skills/user"
check_symlink "$HOME/.claude/settings.json" "modules/claude/settings.json"
check_symlink "$HOME/.claude/hooks" "modules/claude/hooks"
check_symlink "$HOME/.claude/CLAUDE.md" "modules/ai-rules/rules.md"
check_symlink "$HOME/.claude/rules/nix.md" "modules/ai-rules/rules/nix.md"
check_symlink "$HOME/.claude/rules/loop-engineering.md" "modules/ai-rules/rules/loop-engineering.md"
check_symlink "$HOME/.cursor/rules/global-behavioral-rules.mdc" "modules/ai-rules/rules.md"
