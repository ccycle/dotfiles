...
let
  sources = {
    ...
    "devcontainer-0.3.0" = {
      ...
      version = "0.3.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/devcontainer/-/devcontainer-0.3.0.tgz";
        sha512 = "RAZPW5YLy7bgX3rYRjAzxedQPccJPgRPgfXOUGC3uIJSmcw5x4GEigNPswk/IH4N3f2BIeCAlNKeG6l1xYbXzg==";
      };
    };
    "devlop-1.1.0" = {
      name = "devlop";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@google/gemini-cli-0.1.22"
