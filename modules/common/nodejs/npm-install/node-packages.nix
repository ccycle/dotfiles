...
let
  sources = {
    ...
    "webpack-5.100.2" = {
      ...
      src = fetchurl {
        ...
        sha512 = "QaNKAvGCDRh3wW1dsDjeMdDXwZm2vqq3zn6Pvq4rHOEOGSaUMgOOjG2Y9ZbIGzpfkJk9ZYTHpDqgDfeBDcnLaw==";
      };
    };
    "webpack-cli-6.0.1" = {
      name = "webpack-cli";
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."@anthropic-ai/claude-code-1.0.61"
      ...
      sources."@google/gemini-cli-0.1.14"
