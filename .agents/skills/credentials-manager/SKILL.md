...
```bash
.agents/skills/credentials-manager/scripts/edit-secrets.sh <path/to/secrets.yaml>
```
...
```bash
.agents/skills/credentials-manager/scripts/setup-token.sh <token_variable_name>
```
