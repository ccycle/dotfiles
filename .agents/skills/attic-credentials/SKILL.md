...
```bash
.agents/skills/attic-credentials/scripts/init.sh
```
...
```bash
.agents/skills/attic-credentials/scripts/generate-token.sh ci
.agents/skills/attic-credentials/scripts/generate-token.sh smoke
.agents/skills/attic-credentials/scripts/generate-token.sh client <machine>
```
...
```bash
.agents/skills/attic-credentials/scripts/rotate-token.sh ci
.agents/skills/attic-credentials/scripts/rotate-token.sh smoke
.agents/skills/attic-credentials/scripts/rotate-token.sh client <machine>
```
